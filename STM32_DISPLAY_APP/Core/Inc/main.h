...
#define L_RELAY_4_Pin GPIO_PIN_1
#define L_RELAY_4_GPIO_Port GPIOB
#define L_RELAY_3_Pin GPIO_PIN_2
#define L_RELAY_3_GPIO_Port GPIOB
#define L_RELAY_2_Pin GPIO_PIN_12
#define L_RELAY_2_GPIO_Port GPIOB
#define TOUCH_LED4_Pin GPIO_PIN_14
#define TOUCH_LED4_GPIO_Port GPIOB
#define L_RELAY_1_Pin GPIO_PIN_12
#define L_RELAY_1_GPIO_Port GPIOA
